...
namespace App\Modules\ApiJob\Controllers;
...
class ApiLogController extends \App\Http\Controllers\AdminController
{
    ...
    public static $ONLY_MEASURE_ID_ALLOW = [
        'INFECTION' => ['HAI_1_SIR', 'HAI_2_SIR', 'HAI_3_SIR', 'HAI_4_SIR', 'HAI_5_SIR', 'HAI_6_SIR'],
        'SURVEY' => [
        ...
        'COMPLICATION_AND_DEATH' => ['MORT_30_STK', 'COMP_HIP_KNEE', 'MORT_30_AMI', 'MORT_30_CABG', 'MORT_30_COPD', 'MORT_30_HF', 'MORT_30_PN', 'MORT_30_PN', 'PSI_03', 'PSI_04', 'PSI_05', 'PSI_06', 'PSI_08', 'PSI_09', 'PSI_10', 'PSI_11', 'PSI_12', 'PSI_13', 'PSI_14', 'PSI_15', 'PSI_90'],
        'UNPLANNED_VISITS' => [
            'EDAC_30_AMI',
            'EDAC_30_HF',
            'EDAC_30_PN',
    ...
    public static $ONLY_MEASURE_ID_ALLOW_NATIONAL = [
        ...
        'UNPLANNED_VISITS' => ['EDAC_30_AMI', 'EDAC_30_HF', 'EDAC_30_PN', 'OP_32', 'OP_35_ADM', 'OP_35_ED', 'OP_36', 'READM_30_AMI', 'READM_30_CABG', 'READM_30_COPD', 'READM_30_HF', 'READM_30_HIP_KNEE', 'READM_30_HOSP_WIDE', 'READM_30_PN'],
        'TIMELY_AND_EFFECTIVE' => [
            'EDV',
            'IMM_3',
            'OP_18b_NINETIETH',
                        ...
                        foreach ($update_data as &$key) {
                            ...
                            if ($key != null) {
                                if ($request->type_of == 'GENERAL_HOSPITAL') {
                                    ...
                                    $where = ['facility_id' => $key['facility_id']];
                                } elseif ($request->type_of == 'HOSPITAL') {
                                    //                                    echo ( $key['facility_id'] ) ?? 'Facility_id is not required' . 'Facility_id update </br>';
                                    $where = ['facility_id' => $key['facility_id'], 'measure_id' => $key['measure_id']];
                                } else {
                                    //                                    echo $key['measure_id'] . 'measure_id update   </br>';
                                    $where = ['type_of' => $request->type_of, 'measure_id' => $key['measure_id']];
                                }
