...
namespace App\Modules\Order\Respository;
...
class OrderRespository
{
    ...
    public static $storage_disk = 'orders';

    public static $FOR_ORDER_STATUS_VOID = 'void';

    public static $FOR_ORDER_STATUS_CART = 'cart';

    public static $FOR_ORDER_STATUS_PENDING = 'pending';

    public static $FOR_ORDER_STATUS_PROCESSING = 'processing';

    public static $FOR_ORDER_STATUS_ON_HOLD = 'on-hold';

    public static $FOR_ORDER_STATUS_COMPLETED = 'completed';

    public static $FOR_ORDER_STATUS_CANCELLED = 'cancelled';

    public static $FOR_ORDER_STATUS_REFUND = 'refunded';

    public static $FOR_ORDER_STATUS_SHIPPING = 'shipped';

    public static $FOR_ORDER_STATUS_DELIVERY = 'delivered';

    public static $FOR_ORDER_TYPE_CASH_ON_DELIVER = 'cash_on_delivery';

    public static $FOR_ORDER_TYPE_BANK_TRANSFER = 'bank_transfer';

    public static $FOR_ORDER_TYPE_PAY_BY_PAYPAL = 'pay_by_paypal';

    public static $FOR_ORDER_TYPE_PAY_BY_STRIPE = 'pay_by_stripe';
