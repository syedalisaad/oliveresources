<section class="section-box mt-90 mb-50">
    <div class="container">
        <div class="w-50 w-md-100 mx-auto text-center">
            <h3 class="mb-30 wow animate__animated animate__fadeInUp">Choose your
                best plan</h3>
        </div>
        <div class="mw-650 text-center wow animate__animated animate__fadeInUp">
            <p class="mb-35 text-md-lh24 color-black-5">Best for freelance developers who need to save their
                time</p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    <div class="box-pricing-item most-popular">
                        ...
                        <div>
                            <a href="#" class="btn btn-border btnRecommended">Choose plan</a>
                        </div>
                    </div>
                </div>
