...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">Welcome!</h4>
</div>
<div style="padding: 33px 40px 55px; text-align: center;">
<span style="font-size: 22px;  line-height: 30px; color: #000; width: 100%;">Hi,</span>
<br>
{{-- Intro Lines --}}
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">Thanks for Subscribing and being the part of Good Hospital Bad Hospital. Now you will receive updates straight to your inbox.</span>
