...
<h6 style="color: #fff; text-transform: uppercase;  font-weight: 500; letter-spacing: 3px; font-size: 16px; margin: 0 0 10px;">Thank you for contacting us!</h6>
...
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">We appreciate you contacting {{  $site_settings['sites']['site_name'] }}. We will get back to you soon.</span>

<div style="padding: 0px 40px 10px; text-align: center;">
