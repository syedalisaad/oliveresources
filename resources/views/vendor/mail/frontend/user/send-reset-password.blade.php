...
{{--<h6 style="color: #fff; text-transform: uppercase;  font-weight: 500; letter-spacing: 3px; font-size: 16px; margin: 0 0 10px;">Thanks For Signing up!</h6>--}}
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">Password Reset!</h4>
</div>
...
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">We received a request to reset the password for your account.</span>
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">To reset your password, click on the button below.</span>
{{-- Intro Lines --}}
{{-- Action Button --}}
@component('mail::button', ['url' => route( front_route('user.reset_password'), $optional['token'])])
Reset Password
@endcomponent
