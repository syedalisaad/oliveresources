...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">Verify Your E-mail Address</h4>
</div>
<div style="padding: 33px 40px 55px; text-align: center;">
<span style="font-size: 22px;  line-height: 30px; color: #000; width: 100%;">Hi,</span>
 <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">We are happy you signed up with {{  $site_settings['sites']['site_name'] }}. To activate your account, please click on the button below to verify your email address.</span>
{{-- Intro Lines --}}
{{-- Action Button --}}
@component('mail::button', ['url' => route( front_route('user.email.verified'),$data->verifytoken )])
Confirm Email
@endcomponent
