...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">New Email is Verified</h4>
</div>
<div style="padding: 33px 40px 55px; text-align: center;">
<span style="font-size: 22px;  line-height: 30px; color: #000; width: 100%;">Hi,</span>
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">The following user has been verified their email address and now waiting for approval from your side.</span>
<br>
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">User Email : {{$data->email}}</span>


{{-- Action Button --}}
@component('mail::button', ['url' => route( admin_route('user.edit'), $data->id )])
    Click here to Approve Account
@endcomponent
