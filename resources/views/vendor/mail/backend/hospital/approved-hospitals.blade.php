...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">Your Account Has Been Created Successfully</h4>
</div>
...
<br>
{{-- Intro Lines --}}
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">Congratulations - Your hospital "{{ $optional['hospital']->facility_name }}" has been approved!</span>

<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">You can now publish your hospital details from your dashboard.</span>

<br>

{{-- Action Button --}}
@component('mail::button', ['url' => route( front_route('user.dashboard'))])
View Dashboard
@endcomponent
<br>

{{-- Outro Lines --}}
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Previous Hospital Information</strong></span> <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Name</strong> - {{ $optional['hospital']->facility_name }}</span> <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Phone</strong> - {{ $optional['hospital']->phone_number }}</span> <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Reference URL</strong> - {{ $optional['hospital']->ref_url }}</span> <br>


{{-- Outro Lines --}}
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Current Hospital Information</strong></span> <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Name</strong> - {{ $optional['now_hospital']->name }}</span> <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Phone</strong> - {{ $optional['now_hospital']->phone_number }}</span> <br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Reference URL</strong> - {{ $optional['now_hospital']->ref_url }}</span> <br>
