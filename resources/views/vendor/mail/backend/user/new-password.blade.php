...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">Your Account Has Been Approved</h4>
</div>
...
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">Your account has been approved. You can now sign in with the following credentials.</span>
<br>
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Email Address:</strong> {{ $data->email }}</span>
<br>
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;"><strong>Password:</strong> {{$optional['password']}}</span>
