...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">Customer Want to Contact you!</h4>
</div>
...
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px"><a href="tel:+{{ preg_replace( '/[^0-9]/', '',$data->phone) }}">{{$data->phone}}</a></td>
</tr>
<tr>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px"><strong>Email :</strong></td>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px"><a  href="mailto:{{ $data->email}}">{{$data->email}}</a></td>
</tr>
<tr>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px"><strong>Hospital Name :</strong></td>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px">{{$data->hospital_name}}</td>
</tr>


<tr>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px"><strong>Subject :</strong></td>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px">{{$data->subject}}</td>
</tr>
<tr>
