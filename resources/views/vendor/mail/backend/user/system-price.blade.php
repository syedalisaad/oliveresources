...
<h4 style="color: #fff; font-size: 28px;  font-weight: 600; margin: 0;">System Price Has been Received!</h4>
</div>
...
{{-- Intro Lines --}}
<span style="font-size: 16px;  line-height: 28px; color: #000; margin: 0 0 10px; width: 100%;">You are receiving this  email because we received a system price request for {{$data->name}}</span>
<br>
<center>
<table>
<tr>
...
<tr>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px"><strong>Description :</strong></td>
<td style="font-size: 16px;  line-height: 28px; color: #000; padding-left: 15px; min-width: 30px">{{$data->desc??"No Description"}}</td>
</tr>
</table>
</center>
